...
export const MEDICAL_DISCLAIMER = {
  ...
  /**
   * One line. Printed on the doctor-visit medication list export only.
   */
  export:
    "Generated by MedSafe. For informational purposes — consult your doctor.",
} as const;
 ...
 * export  → Doctor-visit medication list export (print/PDF)
 */
